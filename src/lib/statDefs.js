...
export const TEAM_STATS = [
  ...
  {
    key: 'pistolConvWinPct',
    label: 'Pistol conversion %',
    cardTitle: 'PISTOL CONVERSION%',
    compute: (s) => (s.pistolConvRounds ? s.pistolConvWinPct : null),
    format: fpct,
    secondary: (s) => ({ value: s.pistolConvRounds, label: 'bonus rounds' }),
  },
  {
    key: 'antiEcoWinPct',
    label: 'Anti-eco win %',
